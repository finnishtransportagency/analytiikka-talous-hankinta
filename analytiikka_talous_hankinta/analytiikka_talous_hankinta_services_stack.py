...
from analytiikka_talous_hankinta.helper_lambda import *
from analytiikka_talous_hankinta.helper_glue import *
...
"""
class AnalytiikkaTalousHankintaServicesStack(Stack):
