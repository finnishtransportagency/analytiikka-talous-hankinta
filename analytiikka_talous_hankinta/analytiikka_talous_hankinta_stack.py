...
from analytiikka_talous_hankinta.analytiikka_talous_hankinta_stage import AnalytiikkaTalousHankintaStage


class AnalytiikkaTalousHankintaStack(Stack):
    ...
    def __init__(self,
        ...
        # Kehitys stage
        dev_stage = pipeline.add_stage(AnalytiikkaTalousHankintaStage(self,
                                                            f"{projectname}-dev",
                                                            "dev",
        ...
        # Tuotanto stage
        prod_stage = pipeline.add_stage(AnalytiikkaTalousHankintaStage(self,
                                                             f"{projectname}-prod",
                                                             "prod",
