...
from analytiikka_talous_hankinta.analytiikka_talous_hankinta_services_stack import AnalytiikkaTalousHankintaServicesStack
...
class AnalytiikkaMuutStage(Stage):
    ...
    def __init__(self,
        ...
        services_stack = AnalytiikkaTalousHankintaServicesStack(self, 
